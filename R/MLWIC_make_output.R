#' Present output from a model evaluated by \code{MLWIC}
#'
#' \code{MLWIC_make_output} will make a clean csv presenting the results from your run
#' of \code{MLWIC_eval}.
#'
...
#'  \code{MLWIC_eval}. If you used the default in that function, you can use the default here.
#' @param model_dir Absolute path to the location where you stored the L1 folder
#'  that you downloaded from github.
#' @export
MLWIC_make_output <- function(
  output_location,
  model_dir,
